        ...
        <Wrapper>
          ...
          >
            <div className="font-light mb-4">
              👋 Hi, I Am{" "}
              <span className="font-semibold">Bodhisatwa Chakraborty</span>
            </div>
            <div className="max-w-[510px]">
              I am currently a 3rd Year Undergrad in National Institute of
              Technology , Agartala . I am pursuing my degree in Chemcial
              Engineering .
            </div>
          </div>
          {/* INTRO END */}
          ...
          >
            ...
            >
              <a download="" href={resume}>
                <img src={externalLinkIcon} alt="" className="w-[30px] ml-4" />
