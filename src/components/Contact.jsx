        ...
        <Wrapper>
          ...
          <Div className="mb-10 relative">
            ...
            <div className="text-[16px] 2xl:text-[20px] leading-[24px] 2xl:leading-[32px] text-black text-center max-w-[1000px] mx-auto">
              ...
              connect with me on LinkedIn. I'm excited to connect with
              like-minded professionals, creative individuals, and organizations
              that value innovation and quality.
            </div>
          </Div>
          {/* SECTION HEADING END */}
